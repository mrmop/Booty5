 ...
 * @property {boolean}                  preload         - If true then the bitmap will be loaded as soon as it is created
 * @property {boolean}                  loaded          - If true then the bitmap will be loaded as soon as it is created
 */
