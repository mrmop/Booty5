 ...
 * @property {object}                   snd             - Sound instance (re-usable sound only) (internal)
 ...
 * @property {boolean}                  reuse           - When set to false the generated sound Audio will be re-used, this can prevent sounds that are currently playing being replayed whilst currently being played but can help resolve audio playback issues
 ...
 * @property {boolean}                  loaded          - If set to true then this resources has finished loading
 */
 ...
 * @returns {object} An audio object representing the playing sound
 */
