...
Actor.prototype.draw = function()
{
    ...
    {
        if (atlas != null)
            context.drawImage(atlas.bitmap.image, src.x, src.y, src.w, src.h, -cx, -cy, this.w, this.h);
        else
        if (this.bitmap != null)
...
Actor.prototype.drawToCache = function()
{
    ...
    if (atlas != null)
        context.drawImage(atlas.bitmap.image, src.x, src.y, src.w, src.h, 0,0, this.w, this.h);
    else
    if (this.bitmap != null)
        context.drawImage(this.bitmap.image, 0,0, this.w, this.h);
