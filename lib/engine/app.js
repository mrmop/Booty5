...
"use strict";
//
// TheApp is the main app controller and is responsible for general housekeeping and Scene processing, You should
...
//    app.touch_pos.x -= app.canvas_width / 2;
//    app.touch_pos.y -= app.canvas_height / 2;
