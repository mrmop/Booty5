...
Display.prototype.drawPolygon = function(x, y, points, fill, context)
{
    var ctx = this.context;
...
Display.prototype.drawLine = function(x1, y1, x2, y2, context)
{
    var ctx = this.context;
    if (context !== undefined)
        ctx = context;
...
Display.prototype.drawRect = function(x, y, w, h, fill, context)
{
    var ctx = this.context;
    if (context !== undefined)
        ctx = context;
...
Display.prototype.drawRoundRect = function(x, y, w, h, radius, fill, context)
{
    var ctx = this.context;
    if (context !== undefined)
        ctx = context;
...
Display.prototype.drawArc = function(x, y, radius, start_angle, end_angle, fill, context)
{
    var ctx = this.context;
    if (context !== undefined)
        ctx = context;
