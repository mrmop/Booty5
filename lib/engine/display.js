...
function Display(canvas)
{
    ...
    this.canvas_width = canvas.width;           // The width of the canvas
    this.canvas_height = canvas.height;         // The height of the canvas
    this.screen_width = window.innerWidth;      // The width of the container window
    this.screen_height = window.innerHeight;    // The height of the container window
