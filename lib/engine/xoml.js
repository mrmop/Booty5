...
Xoml.prototype.parseSound = function(parent, item)
{
    ...
    var sound = new Sound(item.Name, item.Location, item.Reuse);
...
Xoml.prototype.parseTimeline = function(parent, item)
{
    ...
    for (var t = 0; t < count; t++)
    {
        ...
        var anim = new Animation(timeline, parent, animation.Property, animation.Values, animation.Times, 0, animation.Ease);
...
Xoml.prototype.parseResource = function(parent, resource)
{
...
Xoml.findResource = function(objects, name, type)
{
