...
// - target - Path to or instance of target object
// - properties - Array of property names to tween (e.g. ["x", "y"])
// - start - Array of start values
// - end - Array of end values
...
// - params - Parameter or pass to function
//
...
// - objects - Collection of objects in XOML JSON format (as exported from Booty5 editor) that contains the template
// - scene - Path to or instance of scene that contains the template and its resources
// - template - The name of the object template
// - type - The type of object (e.g. icon, label, scene etc)
// - properties - Object that contains property / value pairs that will be set to created object (e.g. {"vx":0,"vy":0})
//
...
// - target - Path to or instance of object to destroy
//
...
// - target - Path to or instance of scene to set as focus
