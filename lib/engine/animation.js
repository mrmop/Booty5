...
function Animation(timeline, target, property, frames, times, repeat, easing)
{
    ...
    this.frames = frames;                       // Key frame data
    this.times = times;                         // Key frame times
    this.easing = easing;                       // Key frame easing functions
    this.repeat = repeat;                       // Total number of times to repeat animation (0 for forever)
    this.destroy = true;                        // If true then animation will be destroyed when it finishes playing
    this.actions = [];
    this.time_scale = 1.0;                      // Amount to scale time
};
...
//
// Timeline - Manages a collection of animations
// Animation is done using timelines. A timeline is a collection of animations with each animation
// targeting a specific property of a specific object. Multiple frames of animation cab be attached
...
Timeline.prototype.find = function(name)
{
...
//
// TimelineManager - Manages a collection of timelines
//
function TimelineManager()
{
    // Public variables
    this.timelines = [];                  // Collection of timelines
};
